...
import { addToLocal } from "../../assets/utilities/addToLocalStorage/addToLocalStorage";
      ...
      <section className='w-11/12 max-w-7xl mx-auto my-10 space-y-4'>
         ...
         <div className='grid grid-cols-1 lg:grid-cols-3 gap-5'>
            ...
            <div className='bg-purple-50 p-5 rounded-md space-y-4 max-w-lg'>
               ...
               <button
                  className='bg-purple-700 text-white px-5 py-2 rounded-md font-semibold w-full'
                  onClick={() => addToLocal(job)}>
                  Apply Now
               </button>
            </div>
         </div>
